...
class Captura:
    ...
    def inicio(self):
        ...
        self.aguarde(2, "Setando informações...")
        # vamos então localizar nosso div alvo e gravar tudo que está dentro dessa tag numa variavel
        tabela = pagina.find('input' , attrs={'id': 'ctl00_ContentPlaceHolder1_loginmenu1_txtUSUARIO' })['value'] = "010.295.140-38"
        self.aguarde(2, "Setado informações...")
...
class parserTabelaIPCA:
    ...
    def analisaTabela(self, tabela):
        ...
        fname = open(r'C:\Users\benhur.bittencourt\Envs\webscrapy\saida.csv')
        txt_column = ""
